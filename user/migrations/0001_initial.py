    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('school_year', models.CharField(choices=[('Freshmen', 'Freshmen'), ('Sophomore', 'Sophomore'), ('Junior', 'Junior'), ('Senior', 'Senior')], max_length=10)),
                ('description', models.TextField(blank=True, default='This user is too lazy to leave anything behind', null=True)),
